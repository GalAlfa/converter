...
abstract class MarketMapper(
    private val marketTypeId: String,
    ...
    fun map(inMarket: InMarket): OutMarket {
        ...
        return OutMarket().apply {
            this.marketUid = marketUid
            this.marketTypeId = this@MarketMapper.marketTypeId
            this.specifiers = specifiers
            this.selections = outSelections.toMutableList()
        }
    }
