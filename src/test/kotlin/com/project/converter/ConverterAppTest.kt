...
class ConverterAppTest {
    ...
    fun testFullJsonExample() {
        ...
        assertAll(
            ...
            { assertEquals("123456_1", outMarket.marketUid,
    ...
    fun testTotalDecimalSpecifier() {
        ...
        assertAll(
            { assertEquals(18, outMarket.marketTypeId,
                "Market type ID should be '18' for Total market") },
            { assertEquals("e2_18_2.5", outMarket.marketUid,
    ...
    fun testTotalIntegerSpecifier() {
        ...
        val inMarkets: List<InMarket> = objectMapper.readValue(
            input, object : TypeReference<List<InMarket>>() {}
        )
        val outMarket = MarketConversionService().convertAll(inMarkets)[0]

        assertEquals("e3_18_2", outMarket.marketUid,
    ...
    fun testTotalFirstHalf() {
        ...
        assertAll(
            { assertEquals(68, outMarket.marketTypeId,
                "Market type ID should be '68' for 1st half Total market") },
            { assertEquals("e4_68_1.5", outMarket.marketUid,
    ...
    fun exceptionOnUnknownTotalSelection() {
        ...
        assertEquals("Unknown total selection name: notover 2.5",
            exception.message)
    }
    ...
    fun testHandicapSpecifierAbsolute() {
        ...
        val outMarket = MarketConversionService()
            .convertAll(objectMapper.readValue(
                input, object : TypeReference<List<InMarket>>() {}))[0]

        assertAll(
            { assertEquals(16, outMarket.marketTypeId,
                "Market type ID should be '16' for Handicap market") },
            { assertEquals("e6_16_1.5", outMarket.marketUid,
